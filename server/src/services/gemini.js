...
function sourceProfile(article) {
  ...
  if (/gdelt|gnews|currents|newsapi|worldnews/.test(source)) return { host, tier: 'aggregated', note: 'aggregated result; assess the linked outlet, not the aggregator', weight: 0 };
